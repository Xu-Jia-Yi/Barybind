...
def main():
    ...
    if args.run_cfg.mode == 'training':
        ...
        optimizer_pot = torch.optim.AdamW(model.potentials.parameters(), lr=args.run_cfg.learning_rate*2)
    ...
    #   # start evaluation
        ...
        train(model, optimizer, optimizer_pot, train_loader, val_loaders, args, start_step = start_step, verbose_time=False)
